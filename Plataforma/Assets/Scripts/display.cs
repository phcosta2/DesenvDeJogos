...
void OnGUI () {
    ...
    GUI.Label(new Rect(Screen.width / 2 - 100, 390, 200, 100), "mova usando A (direita) e D (esquerda), pule no espaço , suba e desça a escada no w e s" , style2);

    GUI.Label(new Rect(Screen.width / 2 - 100, 410, 200, 100), "e colete todas as moedas para vencer!", style2);
